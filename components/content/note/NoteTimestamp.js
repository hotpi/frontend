...
const getFormattedDate = (date) => {
  ...
  if (dayNow === dayTimestamp && monthNow === monthTimestamp && yearNow === yearTimestamp) {
    return 'Today';
  } else if ((dayNow - 1) === dayTimestamp &&
    monthNow === monthTimestamp &&
    yearNow === yearTimestamp) {
    return 'Yesterday';
  }
  ...
  return (
    <Paper
      ...
      style={{
        ...
        height: 40,
        marginLeft: 1,
        display: type === 'history' || type === 'todo' ? 'inline-flex' : 'none'
      }}
    >
      <DeviceAccessTime style={{
        color: 'grey',
        height: 24,
        width: 24,
        marginLeft: 10,
